...
namespace Gateway
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            //This key value can be configured in database and we can facilate UI to manage this key value.   
            //app.RunHttpServiceGateway("/SFGateway", "fabric:/MyApp/WebService");
            app.RunHttpServiceGateway("/api/uploadFile", "fabric:/HelloWorldStateless/HelloWorldStatelessService");
